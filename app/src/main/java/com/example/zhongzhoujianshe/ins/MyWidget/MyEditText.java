package com.example.zhongzhoujianshe.ins.MyWidget;
...
public class MyEditText extends LinearLayout {
    ...
    private int color_title = getResources().getColor(R.color.light_gray);
    private int color_enter = getResources().getColor(R.color.bluePress);//default: blue
    private int color_invalid = getResources().getColor(R.color.red);//default: red
    private int color_green = getResources().getColor(R.color.green);
    private int color_lightgray = getResources().getColor(R.color.gray);
    private String input_type;
    private String top_title;
    private String top_note_normal;
    private String top_invalid = getResources().getString(R.string.invalid_msg);
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        input_type = mTypedArray.getString(R.styleable.MyEditText_input_type);
    ...
    public void setMyInputType(String type){
